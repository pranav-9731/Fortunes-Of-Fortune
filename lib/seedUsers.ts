...
export const SEED_USERS: AdminUser[] = [
  {
    ...
    scores: [
      { id: "s1", date: "2026-09-18", points: 39 },
      { id: "s2", date: "2026-09-11", points: 34 },
      { id: "s3", date: "2026-09-03", points: 36 },
      { id: "s4", date: "2026-08-27", points: 31 },
      { id: "s5", date: "2026-08-19", points: 33 },
    ],
  },
  {
    ...
    scores: [
      { id: "s6", date: "2026-09-17", points: 28 },
      { id: "s7", date: "2026-09-10", points: 30 },
      { id: "s8", date: "2026-09-02", points: 26 },
      { id: "s9", date: "2026-08-24", points: 32 },
      { id: "s10", date: "2026-08-16", points: 29 },
    ],
  },
  {
    ...
    scores: [
      { id: "s11", date: "2026-09-15", points: 37 },
      { id: "s12", date: "2026-09-08", points: 35 },
    ],
  },
  {
    ...
    scores: [
      { id: "s13", date: "2026-07-30", points: 40 },
      { id: "s14", date: "2026-07-22", points: 38 },
      { id: "s15", date: "2026-07-14", points: 41 },
      { id: "s16", date: "2026-07-06", points: 36 },
      { id: "s17", date: "2026-06-28", points: 39 },
    ],
  },
  {
    ...
    scores: [
      { id: "s18", date: "2026-09-16", points: 33 },
      { id: "s19", date: "2026-09-09", points: 31 },
      { id: "s20", date: "2026-09-01", points: 29 },
      { id: "s21", date: "2026-08-25", points: 34 },
      { id: "s22", date: "2026-08-18", points: 30 },
    ],
  },
  {
    ...
    scores: [
      { id: "s23", date: "2026-09-14", points: 27 },
      { id: "s24", date: "2026-09-07", points: 25 },
      { id: "s25", date: "2026-08-30", points: 30 },
      { id: "s26", date: "2026-08-23", points: 28 },
      { id: "s27", date: "2026-08-15", points: 26 },
    ],
  },
  {
    ...
    scores: [
      { id: "s28", date: "2026-05-12", points: 32 },
    ],
  },
  {
    ...
    scores: [
      { id: "s29", date: "2026-09-18", points: 35 },
      { id: "s30", date: "2026-09-11", points: 37 },
      { id: "s31", date: "2026-09-04", points: 34 },
      { id: "s32", date: "2026-08-28", points: 36 },
      { id: "s33", date: "2026-08-20", points: 33 },
    ],
  },
];
